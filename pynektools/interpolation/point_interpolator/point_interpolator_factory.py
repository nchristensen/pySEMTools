def get_point_interpolator(interpolator_type, *args, **kwargs):
    ...
    if interpolator_type == 'single_point_legendre':
        ...
        from .multiple_point_interpolator_legendre_numpy import LegendreInterpolator as mp_leg_numpy
        n = args[0]
        ...
        from .multiple_point_interpolator_legendre_torch import LegendreInterpolator as mp_leg_torch
        n = args[0]

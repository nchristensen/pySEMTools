...
def tke_budgets_cartesian(comm, msh_fname= "", mean_fname = "", stats_fname=""):
    ...
    fld.add_field(comm, field_name="uu", file_type="fld", file_name=stats_fname, file_key="vel_0", dtype=np.single)
    fld.add_field(comm, field_name="vv", file_type="fld", file_name=stats_fname, file_key="vel_1", dtype=np.single)
    fld.add_field(comm, field_name="ww", file_type="fld", file_name=stats_fname, file_key="vel_2", dtype=np.single)
    fld.add_field(comm, field_name="uv", file_type="fld", file_name=stats_fname, file_key="temp", dtype=np.single)
    fld.add_field(comm, field_name="uw", file_type="fld", file_name=stats_fname, file_key="scal_0", dtype=np.single)
    fld.add_field(comm, field_name="vw", file_type="fld", file_name=stats_fname, file_key="scal_1", dtype=np.single)
